...
async def test_main_with_valid_data_and_query(headers: dict[str, str]) -> None:
...
@pytest.mark.anyio
async def test_main_with_invalid_data_and_valid_query() -> None:
...
@pytest.mark.anyio
async def test_main_with_valid_data_and_invalid_query() -> None:
    """Should return 400 OK and json body."""
...
@pytest.mark.anyio
async def test_main_with_unsupported_data_format() -> None:
...
async def test_main_with_valid_data_and_construct_query(
